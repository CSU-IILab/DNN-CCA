...
class DeepCCA_cnn():
    ...
    def layers1(self):
        ...
        layer1_1 = Conv1D(filters=64, kernel_size=3, activation='relu')(input1)
        layer1_3 = Conv1D(filters=64, kernel_size=3, activation='relu')(layer1_1)
        layer1_3 = Conv1D(filters=64, kernel_size=3, activation='relu')(layer1_3)
        layer1_3 = Conv1D(filters=64, kernel_size=3, activation='relu')(layer1_3)
        layer1_3 = Conv1D(filters=64, kernel_size=3, activation='relu')(layer1_3)
    ...
    def layers2(self):
        ...
        layer2_1 = Conv1D(filters=64, kernel_size=3, activation='relu')(input2)
        layer2_3 = Conv1D(filters=64, kernel_size=3, activation='relu')(layer2_1)
        layer2_3 = Conv1D(filters=64, kernel_size=3, activation='relu')(layer2_3)
        layer2_3 = Conv1D(filters=64, kernel_size=3, activation='relu')(layer2_3)
        layer2_3 = Conv1D(filters=64, kernel_size=3, activation='relu')(layer2_3)
