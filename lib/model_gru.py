from keras.layers import Input, Dense, Dropout, Flatten, GRU, BatchNormalization
...
class DeepCCA_gru():
    ...
    def layers1(self):
        ...
        layer1_1 = GRU(64, return_sequences=True)(input1)
        layer1_3 = GRU(64, return_sequences=True)(layer1_1)
        layer1_3 = GRU(64, return_sequences=True)(layer1_3)
        layer1_3 = GRU(64, return_sequences=True)(layer1_3)
    ...
    def layers2(self):
        ...
        layer2_1 = GRU(64, return_sequences=True)(input2)
        layer2_3 = GRU(64, return_sequences=True)(layer2_1)
        layer2_3 = GRU(64, return_sequences=True)(layer2_3)
        layer2_3 = GRU(64, return_sequences=True)(layer2_3)
